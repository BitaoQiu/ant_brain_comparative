...
names(myproject)
# For a branch includes multiple species, the occurance of ortholog in any one species is regarded as evidence of ortholog in the branch.
# Do that for ant, bee, wasp, ..., and neoptera:
...
# Model the probability of gene lost = 10%, and deemed it as false positive if the distribution probability < 0.01, that is, finding ortholog in ancestral lineage, but missing orthologs in multiple later lineages.
