...
norm_target = combat_edata - rowMeans(combat_edata)
...
pc_data_targett$caste = filter_table$caste
...
levels(pc_data_target$caste)  = c("Gyne","Small worker","Non-reproductive","Reproductive",'Worker')
pc_data_target$caste = factor(pc_data_target$target,levels = c("Gyne","Small worker",'Worker', "Reproductive","Non-reproductive"))
