...
levels(pc_data_test$caste)  = c("Gyne","Small worker","Non-reproductive","Reproductive",'Worker')
pc_data_test$caste = factor(pc_data_test$caste,levels = c("Gyne","Small worker",'Worker', "Reproductive","Non-reproductive"))
levels(pc_data_test$caste) = c("Gyne","Worker","Worker","Reproductive","Non-reproductive")
